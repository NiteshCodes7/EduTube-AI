        ...
        <div className="md:hidden flex justify-center items-center gap-2">
          <div className="md:hidden">
            {pathname === "/dashboard" ? (
              <Button
                size="sm"
                className="w-8 h-8 overflow-hidden bg-gradient-to-r from-green-600 to-blue-600 text-white px-2 py-2 rounded-lg font-semibold shadow-lg hover:opacity-90 transition cursor-pointer"
                onClick={handleDownloadSummary}
              >
                <span className="flex justify-center items-center gap-2 relative z-10">
                  <FileDown className="text-white w-10 h-10" />
                </span>
              </Button>
            ) : (
              <Button
                size="sm"
                className="relative overflow-hidden bg-gradient-to-r from-[#5D2CA8] to-[#3B82F6] text-white px-2 py-2 rounded-lg font-semibold shadow-lg border-none outline-none hover:opacity-90 transition cursor-pointer w-full mt-2"
                onClick={() => router.push("/dashboard")}
              >
