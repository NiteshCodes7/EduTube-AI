...
import { OauthLoginButton } from "@/components/OAuthLogin";
    ...
    <div className="w-full max-w-md mx-auto bg-white p-6 rounded-2xl shadow-lg space-y-6 animate-in fade-in slide-in-from-bottom-6">
      ...
      <div className="relative">
        ...
        <p>
          ...
          <Link
            href={"/resetPassword"}
            className=" text-xs text-customPurplehover:underline"
          >
            Reset Password
          </Link>
        </p>
      ...
      <div className="text-center font-bold text-customPurple">OR</div>
      ...
      <div className="text-center text-sm text-gray-700 mb-2">
        <p>
          ...
          <Link href={"/sign-up"} className="text-customPurple hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
